# ☁️ Secure Multi-Tier VPC Networking Environment

## 📝 Project Overview
This project demonstrates the design and implementation of a secure networking environment on AWS. It focuses on isolating private resources while maintaining secure administrative access and outbound internet connectivity, following AWS best practices.
...
3.  **Security Enforcement:**
    * Created a **Bastion Host** with restricted SSH access (My IP only).
...
### 1. Successful Internet Connectivity (Ping Test)
Verified that private instances can reach the internet safely through the NAT Gateway.

![Ping Test](./connectivity-test-ping.png)
...
![Security Config](./security-groups-config.png)
